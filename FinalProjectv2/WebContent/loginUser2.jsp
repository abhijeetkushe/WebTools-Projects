...
<%@ taglib uri="http://www.servletsuite.com/servlets/caltag"
	prefix="calendar"%>
<%@ taglib uri="http://webtools.org/util" prefix="resource"%>
...
<form:form action="/HealthCarev1/j_spring_security_check" method="POST" commandName="userAccount">
		...
		<tbody>
			...
			<tr>
				<td nowrap="nowrap" style="padding:0px !important;">
					<form:label path="userType">User Type: <font color="orangered">*</font></form:label>
				</td>
				<td>
					<form:select path="userType" id="userType" cssClass="selectionAlt" cssStyle="width: 100px;" >
