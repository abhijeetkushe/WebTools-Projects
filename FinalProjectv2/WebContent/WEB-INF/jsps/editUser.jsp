...
<form:form id="createUser" action="editUser.html" method="POST" commandName="userInfo" enctype="multipart/form-data">
		...
		<tbody>
			...
			<tr>
				...
				<td><form:select onChange="submitForm()"
					...
					cssClass="selectionAlt" cssStyle="width: 100px;" disabled="disabled">
	...
	<fieldset id="fsAccInfo"
		style="padding-right: 10px; padding-left: 10px; float: left; padding-bottom: 10px; width: 90%; padding-top: 10px"
		title="Edit Account Information"><legend
		id="legendAccInfo" style="font-weight: bold">Edit Account
	Information</legend>
	<table border="0" width="474"
		style="margin-top: 10px; margin-bottom: 10px; margin-left: 10px">
		<tbody>
			<tr>
				...
				<td align="left" colspan="3" valign="top" width="75%"><input
					...
					&nbsp;<img src="displayImage.html"  height="10%" width="50%"/>
				</td>
